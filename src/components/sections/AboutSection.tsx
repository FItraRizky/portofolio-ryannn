      ...
      <div className="about__container">
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants as any}
          >
            Seorang fullstack developer yang passionate dalam menciptakan solusi
            teknologi yang memberikan dampak positif. Dengan pengalaman lebih
            dari 3 tahun, saya terus belajar dan berkembang dalam dunia
              ...
              <CardBody>
                <div className="about__story-content">
                  <div className="about__story-text">
                    <p>
                      Perjalanan saya dimulai dari rasa penasaran terhadap
                      bagaimana website dan aplikasi bekerja. Dari seorang
                      pemula yang belajar HTML dan CSS, kini saya telah
                      berkembang menjadi fullstack developer yang mampu
                      menangani proyek dari konsep hingga deployment.
                    </p>
                    <p>
                      Saya percaya bahwa teknologi adalah alat untuk memecahkan
                      masalah nyata. Setiap baris kode yang saya tulis memiliki
                      tujuan untuk menciptakan pengalaman yang lebih baik bagi
                      pengguna.
                    </p>
                    <p>
                      Di luar coding, saya senang berbagi pengetahuan melalui
                      blog, mentoring junior developer, dan berkontribusi pada
                  ...
                  <div className="about__story-highlights">
                    <div className="about__highlight">
                      ...
                      <div>
                        <h4>Mission</h4>
                        <p>
                          Menciptakan solusi teknologi yang user-centric dan
                          scalable
                        </p>
                      </div>
                    </div>
                    <div className="about__highlight">
                      ...
                      <div>
                        <h4>Vision</h4>
                        <p>
                          Menjadi developer yang dapat memberikan dampak positif
                          melalui teknologi
                        </p>
                      </div>
                    </div>
                    <div className="about__highlight">
                      ...
                      <div>
                        <h4>Values</h4>
                        <p>
                          Continuous learning, collaboration, dan quality-driven
                          development
                        </p>
                      </div>
                    </div>
              ...
              {tabs.map((tab) => (
                <button
                  ...
                  className={`about__tab ${
                    activeTab === tab.id ? "about__tab--active" : ""
                  }`}
                              ...
                              >
                                ...
                                <div className="about__skill-progress">
                                  <motion.div
                                    ...
                                    custom={skill.level}
                                    style={{
                                      backgroundColor: getSkillColor(category),
                                    }}
                                  />
                                </div>
                        ...
                        <Card className="about__experience-card">
                          <CardHeader>
                            <div className="about__experience-header">
                              <div>
                                <h4 className="about__experience-title">
                                  {exp.position}
                                </h4>
                              ...
                              <div className="about__experience-period">
                                <span className="about__experience-duration">
                                  {exp.duration}
                                </span>
                                <span className="about__experience-type">
                                  {exp.type}
                                </span>
                              </div>
                            </div>
                    ...
                    {education.map((edu) => (
                      ...
                      >
                        <Card className="about__education-card">
                          ...
                          <CardBody>
                            <p className="about__education-description">
                              {edu.description}
                            </p>
            ...
            >
              <div className="about__fact">
                ...
                <div>
                  ...
                  <p>
                    Mengonsumsi rata-rata 4 cangkir kopi per hari untuk fuel
                    coding sessions
                  </p>
                </div>
              </div>
            ...
            >
              <div className="about__fact">
                ...
                <div>
                  ...
                  <p>
                    Selalu mengikuti perkembangan teknologi terbaru dan
                    mengambil online courses
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="about__fact">
                ...
                <div>
                  ...
                  <p>
                    Bermain strategy games untuk melatih logical thinking dan
                    problem solving
                  </p>
                </div>
              </div>
            ...
            >
              <div className="about__fact">
                ...
                <div>
                  <h4>Tech Blogger</h4>
                  <p>
                    Menulis artikel teknis dan tutorial untuk berbagi knowledge
                    dengan community
                  </p>
                </div>
              </div>
            ...
            >
              <div className="about__fact">
                ...
                <div>
                  ...
                  <p>
                    Rutin olahraga dan hiking untuk menjaga kesehatan fisik dan
                    mental
                  </p>
                </div>
              </div>
